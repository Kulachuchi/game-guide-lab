...
//There were some changes with the MongoDB connection string to make this project connected to MongoDB
require('dotenv').config();
const mongoDBPassword='black.D0g'//process.env.MYMONGODBPASSWORD
const sessionSecret='my secret thing'//process.env.MYSESSIONSECRET
...
mongoose.connect(`mongodb+srv://CCO6005-08:${mongoDBPassword}@cluster0.lpfnqqx.mongodb.net/blog?retryWrites=true&w=majority`)
